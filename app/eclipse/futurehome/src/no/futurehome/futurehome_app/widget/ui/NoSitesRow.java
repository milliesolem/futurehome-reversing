...
public final class NoSitesRow implements Row {
  ...
  private final RemoteViews getViewsForBrightness() {
    ...
    if (this.widgetData.isDark()) {
      remoteViews = new RemoteViews(this.context.getPackageName(), 2131492958);
    } else {
      remoteViews = new RemoteViews(this.context.getPackageName(), 2131492959);
    } 
    return remoteViews;
  }
    ...
    if (i != 1) {
      if (i != 2) {
        if (i != 3) {
          if (i != 4) {
            if (i == 5) {
              paramRemoteViews.setTextViewText(2131296520, this.context.getString(2131689614));
            } else {
              throw new NoWhenBranchMatchedException();
            } 
          } else {
            paramRemoteViews.setTextViewText(2131296520, this.context.getString(2131689567));
          } 
        } else {
          paramRemoteViews.setTextViewText(2131296520, this.context.getString(2131689529));
        } 
      } else {
        paramRemoteViews.setTextViewText(2131296520, this.context.getString(2131689593));
      } 
    } else {
      paramRemoteViews.setTextViewText(2131296520, this.context.getString(2131689546));
    } 
  }
  ...
  public RemoteViews getRemoteViews(int paramInt) {
    ...
    intent.putExtra("futurehome.widget.ActionName", "futurehome.widget.ActionMoveToAddSite");
    remoteViews.setOnClickFillInIntent(2131296520, intent);
