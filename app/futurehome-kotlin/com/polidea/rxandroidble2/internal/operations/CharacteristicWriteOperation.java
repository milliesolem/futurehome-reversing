...
public class CharacteristicWriteOperation extends SingleResponseOperation<byte[]> {
   ...
   CharacteristicWriteOperation(
      RxBleGattCallback var1, BluetoothGatt var2, @Named("operation-timeout") TimeoutConfiguration var3, BluetoothGattCharacteristic var4, byte[] var5
   ) {
      super(var2, var1, BleGattOperationType.CHARACTERISTIC_WRITE, var3);
   ...
   protected Single<byte[]> getCallback(RxBleGattCallback var1) {
      return var1.getOnCharacteristicWrite()
   ...
   protected boolean startOperation(BluetoothGatt var1) {
      ...
      return var1.writeCharacteristic(this.bluetoothGattCharacteristic);
   }

   @Override
   public String toString() {
      StringBuilder var1 = new StringBuilder("CharacteristicWriteOperation{");
      var1.append(super.toString());
      var1.append(", characteristic=");
      var1.append(new LoggerUtil.AttributeLogWrapper(this.bluetoothGattCharacteristic.getUuid(), this.data, true));
      var1.append('}');
