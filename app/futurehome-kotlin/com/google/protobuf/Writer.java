...
interface Writer {
   ...
   public static enum FieldOrder {
      ASCENDING,
      DESCENDING;
      private static final Writer.FieldOrder[] $VALUES;

      // $VF: Failed to inline enum fields
      // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
      static {
         Writer.FieldOrder var1 = new Writer.FieldOrder();
         ASCENDING = var1;
         Writer.FieldOrder var0 = new Writer.FieldOrder();
         DESCENDING = var0;
         $VALUES = new Writer.FieldOrder[]{var1, var0};
      }
   }
}
