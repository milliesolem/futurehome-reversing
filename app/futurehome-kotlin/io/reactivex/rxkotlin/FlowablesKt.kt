...
public fun <T : Any, U : Any> Flowable<T>.withLatestFrom(other: Publisher<U>): Flowable<Pair<T, U>> {
...
@CheckReturnValue
@SchedulerSupport("none")
public inline fun <T : Any, U : Any, R : Any> Flowable<T>.withLatestFrom(other: Publisher<U>, crossinline combiner: (T, U) -> R): Flowable<R> {
   Intrinsics.checkParameterIsNotNull(var0, "$this$withLatestFrom");
   Intrinsics.checkParameterIsNotNull(var1, "other");
...
@CheckReturnValue
@SchedulerSupport("none")
public fun <T : Any, T1 : Any, T2 : Any> Flowable<T>.withLatestFrom(o1: Publisher<T1>, o2: Publisher<T2>): Flowable<Triple<T, T1, T2>> {
   Intrinsics.checkParameterIsNotNull(var0, "$this$withLatestFrom");
...
@CheckReturnValue
@SchedulerSupport("none")
public inline fun <T : Any, T1 : Any, T2 : Any, R : Any> Flowable<T>.withLatestFrom(
   o1: Publisher<T1>,
   o2: Publisher<T2>,
...
@CheckReturnValue
@SchedulerSupport("none")
public inline fun <T : Any, T1 : Any, T2 : Any, T3 : Any, R : Any> Flowable<T>.withLatestFrom(
   o1: Publisher<T1>,
   o2: Publisher<T2>,
   o3: Publisher<T3>,
...
@CheckReturnValue
@SchedulerSupport("none")
public inline fun <T : Any, T1 : Any, T2 : Any, T3 : Any, T4 : Any, R : Any> Flowable<T>.withLatestFrom(
   o1: Publisher<T1>,
   o2: Publisher<T2>,
   o3: Publisher<T3>,
   o4: Publisher<T4>,
...
@CheckReturnValue
@SchedulerSupport("none")
public fun <T : Any, U : Any> Flowable<T>.zipWith(other: Publisher<U>): Flowable<Pair<T, U>> {
...
@CheckReturnValue
@SchedulerSupport("none")
public inline fun <T : Any, U : Any, R : Any> Flowable<T>.zipWith(other: Publisher<U>, crossinline zipper: (T, U) -> R): Flowable<R> {
   Intrinsics.checkParameterIsNotNull(var0, "$this$zipWith");
   Intrinsics.checkParameterIsNotNull(var1, "other");
