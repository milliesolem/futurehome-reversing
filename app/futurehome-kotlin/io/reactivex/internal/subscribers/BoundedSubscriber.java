...
public final class BoundedSubscriber<T>
   ...
   public BoundedSubscriber(Consumer<? super T> var1, Consumer<? super Throwable> var2, Action var3, Consumer<? super Subscription> var4, int var5) {
      this.onNext = var1;
      this.onError = var2;
      this.onComplete = var3;
      this.onSubscribe = var4;
      this.bufferSize = var5;
      this.limit = var5 - (var5 >> 2);
   }
