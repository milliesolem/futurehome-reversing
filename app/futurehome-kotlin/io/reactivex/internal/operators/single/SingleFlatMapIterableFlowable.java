...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
   ...
   public SingleFlatMapIterableFlowable(SingleSource<T> var1, Function<? super T, ? extends Iterable<? extends R>> var2) {
      this.source = var1;
      this.mapper = var2;
   }
   ...
   protected void subscribeActual(Subscriber<? super R> var1) {
      this.source.subscribe(new SingleFlatMapIterableFlowable.FlatMapIterableObserver<>(var1, this.mapper));
   }
   ...
   static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
      ...
      // $VF: Could not inline inconsistent finally blocks
      // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
      void slowPath(Subscriber<? super R> var1, Iterator<? extends R> var2) {
