...
public final class MaybeFlatMapIterableObservable<T, R> extends Observable<R> {
   ...
   public MaybeFlatMapIterableObservable(MaybeSource<T> var1, Function<? super T, ? extends Iterable<? extends R>> var2) {
      this.source = var1;
      this.mapper = var2;
   }
   ...
   protected void subscribeActual(Observer<? super R> var1) {
      this.source.subscribe(new MaybeFlatMapIterableObservable.FlatMapIterableObserver<>(var1, this.mapper));
   }
