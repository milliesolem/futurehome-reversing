...
public final class MaybeFilterSingle<T> extends Maybe<T> {
   ...
   public MaybeFilterSingle(SingleSource<T> var1, Predicate<? super T> var2) {
      this.source = var1;
      this.predicate = var2;
   }
   ...
   protected void subscribeActual(MaybeObserver<? super T> var1) {
      this.source.subscribe(new MaybeFilterSingle.FilterMaybeObserver<>(var1, this.predicate));
   }
