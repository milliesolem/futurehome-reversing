...
public final class MaybeFlatMapSingle<T, R> extends Single<R> {
   ...
   public MaybeFlatMapSingle(MaybeSource<T> var1, Function<? super T, ? extends SingleSource<? extends R>> var2) {
      this.source = var1;
      this.mapper = var2;
   }
   ...
   protected void subscribeActual(SingleObserver<? super R> var1) {
      this.source.subscribe(new MaybeFlatMapSingle.FlatMapMaybeObserver<>(var1, this.mapper));
   }
   ...
   static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
      ...
      FlatMapMaybeObserver(SingleObserver<? super R> var1, Function<? super T, ? extends SingleSource<? extends R>> var2) {
      ...
      public void onSuccess(T var1) {
         ...
         if (!this.isDisposed()) {
            var1.subscribe(new MaybeFlatMapSingle.FlatMapSingleObserver<>(this, this.downstream));
         }
      }
   }
