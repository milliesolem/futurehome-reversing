...
public final class MaybeFlatMapCompletable<T> extends Completable {
   ...
   public MaybeFlatMapCompletable(MaybeSource<T> var1, Function<? super T, ? extends CompletableSource> var2) {
      this.source = var1;
      this.mapper = var2;
   }
   ...
   protected void subscribeActual(CompletableObserver var1) {
      MaybeFlatMapCompletable.FlatMapCompletableObserver var2 = new MaybeFlatMapCompletable.FlatMapCompletableObserver<>(var1, this.mapper);
