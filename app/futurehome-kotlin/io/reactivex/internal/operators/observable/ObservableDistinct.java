...
public final class ObservableDistinct<T, K> extends AbstractObservableWithUpstream<T, T> {
   ...
   public ObservableDistinct(ObservableSource<T> var1, Function<? super T, K> var2, Callable<? extends Collection<? super K>> var3) {
      super(var1);
   ...
   protected void subscribeActual(Observer<? super T> var1) {
      ...
      this.source.subscribe(new ObservableDistinct.DistinctObserver<>(var1, this.keySelector, var2));
   }
   ...
   static final class DistinctObserver<T, K> extends BasicFuseableObserver<T, T> {
      ...
      DistinctObserver(Observer<? super T> var1, Function<? super T, K> var2, Collection<? super K> var3) {
         super(var1);
         this.keySelector = var2;
      ...
      public T poll() throws Exception {
         ...
         do {
            var1 = this.qd.poll();
         } while (var1 != null && !this.collection.add(ObjectHelper.requireNonNull(this.keySelector.apply((T)var1), "The keySelector returned a null key")));
