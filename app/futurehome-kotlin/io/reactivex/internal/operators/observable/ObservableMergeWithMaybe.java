...
public final class ObservableMergeWithMaybe<T> extends AbstractObservableWithUpstream<T, T> {
   ...
   public ObservableMergeWithMaybe(Observable<T> var1, MaybeSource<? extends T> var2) {
      super(var1);
      this.other = var2;
   }
   ...
   protected void subscribeActual(Observer<? super T> var1) {
      ObservableMergeWithMaybe.MergeWithObserver var2 = new ObservableMergeWithMaybe.MergeWithObserver(var1);
   ...
   static final class MergeWithObserver<T> extends AtomicInteger implements Observer<T>, Disposable {
      ...
      final ObservableMergeWithMaybe.MergeWithObserver.OtherObserver<T> otherObserver;
      ...
      static final class OtherObserver<T> extends AtomicReference<Disposable> implements MaybeObserver<T> {
         ...
         OtherObserver(ObservableMergeWithMaybe.MergeWithObserver<T> var1) {
            this.parent = var1;
         }
