...
public final class ObservableReduceWithSingle<T, R> extends Single<R> {
   ...
   public ObservableReduceWithSingle(ObservableSource<T> var1, Callable<R> var2, BiFunction<R, ? super T, R> var3) {
      this.source = var1;
   ...
   protected void subscribeActual(SingleObserver<? super R> var1) {
      ...
      this.source.subscribe(new ObservableReduceSeedSingle.ReduceSeedObserver<>(var1, this.reducer, (R)var2));
   }
}
