...
public final class ObservableConcatMapSingle<T, R> extends Observable<R> {
   ...
   public ObservableConcatMapSingle(Observable<T> var1, Function<? super T, ? extends SingleSource<? extends R>> var2, ErrorMode var3, int var4) {
      this.source = var1;
      this.mapper = var2;
      this.errorMode = var3;
      this.prefetch = var4;
   ...
   protected void subscribeActual(Observer<? super R> var1) {
      if (!ScalarXMapZHelper.tryAsSingle(this.source, this.mapper, var1)) {
         this.source.subscribe(new ObservableConcatMapSingle.ConcatMapSingleMainObserver<>(var1, this.mapper, this.prefetch, this.errorMode));
      }
   }
   ...
   static final class ConcatMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
      ...
      ConcatMapSingleMainObserver(Observer<? super R> var1, Function<? super T, ? extends SingleSource<? extends R>> var2, int var3, ErrorMode var4) {
         ...
         if (this.getAndIncrement() == 0) {
            ...
            while (true) {
               if (this.cancelled) {
                  ...
                  int var3 = this.state;
                  if (var7.get() != null && (var8 == ErrorMode.IMMEDIATE || var8 == ErrorMode.BOUNDARY && var3 == 0)) {
                     var6.clear();
                     this.item = null;
                     var5.onError(var7.terminate());
                     return;
                  }
                  ...
                  if (var3 == 0) {
                     ...
                     SingleSource var9 = (SingleSource)var6.poll();
                     if (var9 == null) {
                        var2 = true;
                     }

                     if (var4 && var2) {
                        Throwable var13 = var7.terminate();
                        if (var13 == null) {
                           var5.onComplete();
                        } else {
                           var5.onError(var13);
                     ...
                     if (!var2) {
                        try {
                           var9 = ObjectHelper.requireNonNull(this.mapper.apply((T)var9), "The mapper returned a null SingleSource");
                        } catch (Throwable var11) {
                           Exceptions.throwIfFatal(var11);
                           this.upstream.dispose();
                           var6.clear();
                           var7.addThrowable(var11);
                           var5.onError(var7.terminate());
                           return;
                        }
      ...
      static final class ConcatMapSingleObserver<R> extends AtomicReference<Disposable> implements SingleObserver<R> {
         ...
         ConcatMapSingleObserver(ObservableConcatMapSingle.ConcatMapSingleMainObserver<?, R> var1) {
            this.parent = var1;
         }
