...
public final class MaybeFlatMapObservable<T, R> extends Observable<R> {
   ...
   public MaybeFlatMapObservable(MaybeSource<T> var1, Function<? super T, ? extends ObservableSource<? extends R>> var2) {
      this.source = var1;
      this.mapper = var2;
   }
   ...
   protected void subscribeActual(Observer<? super R> var1) {
      MaybeFlatMapObservable.FlatMapObserver var2 = new MaybeFlatMapObservable.FlatMapObserver<>(var1, this.mapper);
