...
public final class FlowableAll<T> extends AbstractFlowableWithUpstream<T, Boolean> {
   ...
   public FlowableAll(Flowable<T> var1, Predicate<? super T> var2) {
      super(var1);
      this.predicate = var2;
   }
   ...
   protected void subscribeActual(Subscriber<? super Boolean> var1) {
      this.source.subscribe(new FlowableAll.AllSubscriber<>(var1, this.predicate));
   }
   ...
   static final class AllSubscriber<T> extends DeferredScalarSubscription<Boolean> implements FlowableSubscriber<T> {
      ...
      AllSubscriber(Subscriber<? super Boolean> var1, Predicate<? super T> var2) {
         super(var1);
         this.predicate = var2;
      }
