...
public final class FlowableAnySingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
   ...
   public FlowableAnySingle(Flowable<T> var1, Predicate<? super T> var2) {
      this.source = var1;
      this.predicate = var2;
   }
   ...
   protected void subscribeActual(SingleObserver<? super Boolean> var1) {
      this.source.subscribe(new FlowableAnySingle.AnySubscriber<>(var1, this.predicate));
   }
   ...
   static final class AnySubscriber<T> implements FlowableSubscriber<T>, Disposable {
      ...
      AnySubscriber(SingleObserver<? super Boolean> var1, Predicate<? super T> var2) {
