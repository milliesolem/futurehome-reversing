...
public abstract class Observable<T> implements ObservableSource<T> {
   ...
   public static <T> Observable<T> amb(Iterable<? extends ObservableSource<? extends T>> var0) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      return RxJavaPlugins.onAssembly(new ObservableAmb<>(null, var0));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> ambArray(ObservableSource<? extends T>... var0) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      int var1 = var0.length;
      if (var1 == 0) {
         return empty();
      } else {
         return var1 == 1 ? wrap(var0[0]) : RxJavaPlugins.onAssembly(new ObservableAmb<>(var0, null));
      }
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Observable<R> combineLatest(
      ObservableSource<? extends T1> var0,
      ObservableSource<? extends T2> var1,
      ObservableSource<? extends T3> var2,
      ObservableSource<? extends T4> var3,
      ObservableSource<? extends T5> var4,
      ObservableSource<? extends T6> var5,
      ObservableSource<? extends T7> var6,
      ObservableSource<? extends T8> var7,
      ObservableSource<? extends T9> var8,
      ...
      return combineLatest(Functions.toFunction(var9), bufferSize(), var0, var1, var2, var3, var4, var5, var6, var7, var8);
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Observable<R> combineLatest(
      ...
      ObjectHelper.requireNonNull(var6, "source7 is null");
      ObjectHelper.requireNonNull(var7, "source8 is null");
      return combineLatest(Functions.toFunction(var8), bufferSize(), var0, var1, var2, var3, var4, var5, var6, var7);
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, T7, R> Observable<R> combineLatest(
      ...
      ObjectHelper.requireNonNull(var5, "source6 is null");
      ObjectHelper.requireNonNull(var6, "source7 is null");
      return combineLatest(Functions.toFunction(var7), bufferSize(), var0, var1, var2, var3, var4, var5, var6);
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, R> Observable<R> combineLatest(
      ...
      ObjectHelper.requireNonNull(var4, "source5 is null");
      ObjectHelper.requireNonNull(var5, "source6 is null");
      return combineLatest(Functions.toFunction(var6), bufferSize(), var0, var1, var2, var3, var4, var5);
   }
   ...
   public static <T1, T2, T3, T4, T5, R> Observable<R> combineLatest(
      ...
      ObjectHelper.requireNonNull(var3, "source4 is null");
      ObjectHelper.requireNonNull(var4, "source5 is null");
      return combineLatest(Functions.toFunction(var5), bufferSize(), var0, var1, var2, var3, var4);
   }
   ...
   public static <T1, T2, T3, T4, R> Observable<R> combineLatest(
      ...
      ObjectHelper.requireNonNull(var2, "source3 is null");
      ObjectHelper.requireNonNull(var3, "source4 is null");
      return combineLatest(Functions.toFunction(var4), bufferSize(), var0, var1, var2, var3);
   }
   ...
   public static <T1, T2, T3, R> Observable<R> combineLatest(
      ...
      ObjectHelper.requireNonNull(var1, "source2 is null");
      ObjectHelper.requireNonNull(var2, "source3 is null");
      return combineLatest(Functions.toFunction(var3), bufferSize(), var0, var1, var2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T1, T2, R> Observable<R> combineLatest(
      ObservableSource<? extends T1> var0, ObservableSource<? extends T2> var1, BiFunction<? super T1, ? super T2, ? extends R> var2
   ) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      return combineLatest(Functions.toFunction(var2), bufferSize(), var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatest(Function<? super Object[], ? extends R> var0, int var1, ObservableSource<? extends T>... var2) {
      return combineLatest(var2, var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatest(Iterable<? extends ObservableSource<? extends T>> var0, Function<? super Object[], ? extends R> var1) {
   ...
   public static <T, R> Observable<R> combineLatest(
      Iterable<? extends ObservableSource<? extends T>> var0, Function<? super Object[], ? extends R> var1, int var2
   ) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      ObjectHelper.requireNonNull(var1, "combiner is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
      return RxJavaPlugins.onAssembly(new ObservableCombineLatest<>(null, var0, var1, var2 << 1, false));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatest(ObservableSource<? extends T>[] var0, Function<? super Object[], ? extends R> var1) {
      return combineLatest(var0, var1, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatest(ObservableSource<? extends T>[] var0, Function<? super Object[], ? extends R> var1, int var2) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      if (var0.length == 0) {
         return empty();
      } else {
         ObjectHelper.requireNonNull(var1, "combiner is null");
         ObjectHelper.verifyPositive(var2, "bufferSize");
         return RxJavaPlugins.onAssembly(new ObservableCombineLatest<>(var0, null, var1, var2 << 1, false));
      }
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatestDelayError(Function<? super Object[], ? extends R> var0, int var1, ObservableSource<? extends T>... var2) {
   ...
   public static <T, R> Observable<R> combineLatestDelayError(
      Iterable<? extends ObservableSource<? extends T>> var0, Function<? super Object[], ? extends R> var1
   ) {
   ...
   public static <T, R> Observable<R> combineLatestDelayError(
      ...
      ObjectHelper.requireNonNull(var1, "combiner is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
      return RxJavaPlugins.onAssembly(new ObservableCombineLatest<>(null, var0, var1, var2 << 1, true));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatestDelayError(ObservableSource<? extends T>[] var0, Function<? super Object[], ? extends R> var1) {
      return combineLatestDelayError(var0, var1, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> combineLatestDelayError(ObservableSource<? extends T>[] var0, Function<? super Object[], ? extends R> var1, int var2) {
      ObjectHelper.verifyPositive(var2, "bufferSize");
      ObjectHelper.requireNonNull(var1, "combiner is null");
      return var0.length == 0 ? empty() : RxJavaPlugins.onAssembly(new ObservableCombineLatest<>(var0, null, var1, var2 << 1, true));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concat(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      return concat(var0, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concat(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concat(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concat(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, ObservableSource<? extends T> var2) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      ObjectHelper.requireNonNull(var2, "source3 is null");
   ...
   public static <T> Observable<T> concat(
      ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, ObservableSource<? extends T> var2, ObservableSource<? extends T> var3
   ) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      ObjectHelper.requireNonNull(var2, "source3 is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concat(Iterable<? extends ObservableSource<? extends T>> var0) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatArray(ObservableSource<? extends T>... var0) {
      if (var0.length == 0) {
         return empty();
      } else {
         return var0.length == 1
            ? wrap(var0[0])
            : RxJavaPlugins.onAssembly(new ObservableConcatMap<>(fromArray(var0), Functions.identity(), bufferSize(), ErrorMode.BOUNDARY));
      }
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatArrayDelayError(ObservableSource<? extends T>... var0) {
      if (var0.length == 0) {
         return empty();
      } else {
         return var0.length == 1 ? wrap(var0[0]) : concatDelayError(fromArray(var0));
      }
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatArrayEager(int var0, int var1, ObservableSource<? extends T>... var2) {
      return fromArray(var2).concatMapEagerDelayError(Functions.identity(), var0, var1, false);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatArrayEager(ObservableSource<? extends T>... var0) {
      return concatArrayEager(bufferSize(), bufferSize(), var0);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatArrayEagerDelayError(int var0, int var1, ObservableSource<? extends T>... var2) {
      return fromArray(var2).concatMapEagerDelayError(Functions.identity(), var0, var1, true);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatArrayEagerDelayError(ObservableSource<? extends T>... var0) {
      return concatArrayEagerDelayError(bufferSize(), bufferSize(), var0);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatDelayError(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      return concatDelayError(var0, bufferSize(), true);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatDelayError(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1, boolean var2) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatDelayError(Iterable<? extends ObservableSource<? extends T>> var0) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      return concatDelayError(fromIterable(var0));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatEager(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      return concatEager(var0, bufferSize(), bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatEager(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1, int var2) {
      return wrap(var0).concatMapEager(Functions.identity(), var1, var2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatEager(Iterable<? extends ObservableSource<? extends T>> var0) {
      return concatEager(var0, bufferSize(), bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> concatEager(Iterable<? extends ObservableSource<? extends T>> var0, int var1, int var2) {
      return fromIterable(var0).concatMapEagerDelayError(Functions.identity(), var1, var2, false);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> create(ObservableOnSubscribe<T> var0) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> defer(Callable<? extends ObservableSource<? extends T>> var0) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> error(Throwable var0) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> error(Callable<? extends Throwable> var0) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> fromArray(T... var0) {
      ObjectHelper.requireNonNull(var0, "items is null");
      if (var0.length == 0) {
         return empty();
      } else {
         return var0.length == 1 ? just((T)var0[0]) : RxJavaPlugins.onAssembly(new ObservableFromArray<>((T[])var0));
      }
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> fromCallable(Callable<? extends T> var0) {
      ObjectHelper.requireNonNull(var0, "supplier is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> fromFuture(Future<? extends T> var0) {
      ObjectHelper.requireNonNull(var0, "future is null");
      return RxJavaPlugins.onAssembly(new ObservableFromFuture<>(var0, 0L, null));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> fromFuture(Future<? extends T> var0, long var1, TimeUnit var3) {
      ObjectHelper.requireNonNull(var0, "future is null");
   ...
   public static <T> Observable<T> fromFuture(Future<? extends T> var0, long var1, TimeUnit var3, Scheduler var4) {
   ...
   @CheckReturnValue
   @SchedulerSupport("custom")
   public static <T> Observable<T> fromFuture(Future<? extends T> var0, Scheduler var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> fromIterable(Iterable<? extends T> var0) {
      ObjectHelper.requireNonNull(var0, "source is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> fromPublisher(Publisher<? extends T> var0) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> generate(Consumer<Emitter<T>> var0) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, S> Observable<T> generate(Callable<S> var0, BiConsumer<S, Emitter<T>> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, S> Observable<T> generate(Callable<S> var0, BiConsumer<S, Emitter<T>> var1, Consumer<? super S> var2) {
      ObjectHelper.requireNonNull(var1, "generator is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, S> Observable<T> generate(Callable<S> var0, BiFunction<S, Emitter<T>, S> var1) {
      return generate(var0, var1, Functions.emptyConsumer());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, S> Observable<T> generate(Callable<S> var0, BiFunction<S, Emitter<T>, S> var1, Consumer<? super S> var2) {
   ...
   public static Observable<Long> intervalRange(long var0, long var2, long var4, long var6, TimeUnit var8, Scheduler var9) {
      long var13;
      int var10 = (var13 = var2 - 0L) == 0L ? 0 : (var13 < 0L ? -1 : 1);
      if (var10 >= 0) {
         if (var10 == 0) {
         ...
         StringBuilder var12 = new StringBuilder("count >= 0 required but it was ");
         var12.append(var2);
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0) {
      ObjectHelper.requireNonNull(var0, "item is null");
      return RxJavaPlugins.onAssembly(new ObservableJust<>((T)var0));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      return fromArray((T[])(new Object[]{var0, var1}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3, T var4) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      ObjectHelper.requireNonNull(var4, "item5 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3, var4}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3, T var4, T var5) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      ObjectHelper.requireNonNull(var4, "item5 is null");
      ObjectHelper.requireNonNull(var5, "item6 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3, var4, var5}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3, T var4, T var5, T var6) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      ObjectHelper.requireNonNull(var4, "item5 is null");
      ObjectHelper.requireNonNull(var5, "item6 is null");
      ObjectHelper.requireNonNull(var6, "item7 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3, var4, var5, var6}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3, T var4, T var5, T var6, T var7) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      ...
      ObjectHelper.requireNonNull(var5, "item6 is null");
      ObjectHelper.requireNonNull(var6, "item7 is null");
      ObjectHelper.requireNonNull(var7, "item8 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3, var4, var5, var6, var7}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3, T var4, T var5, T var6, T var7, T var8) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      ...
      ObjectHelper.requireNonNull(var6, "item7 is null");
      ObjectHelper.requireNonNull(var7, "item8 is null");
      ObjectHelper.requireNonNull(var8, "item9 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3, var4, var5, var6, var7, var8}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> just(T var0, T var1, T var2, T var3, T var4, T var5, T var6, T var7, T var8, T var9) {
      ObjectHelper.requireNonNull(var0, "item1 is null");
      ObjectHelper.requireNonNull(var1, "item2 is null");
      ObjectHelper.requireNonNull(var2, "item3 is null");
      ObjectHelper.requireNonNull(var3, "item4 is null");
      ...
      ObjectHelper.requireNonNull(var7, "item8 is null");
      ObjectHelper.requireNonNull(var8, "item9 is null");
      ObjectHelper.requireNonNull(var9, "item10 is null");
      return fromArray((T[])(new Object[]{var0, var1, var2, var3, var4, var5, var6, var7, var8, var9}));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      return fromArray(var0, var1).flatMap(Functions.identity(), false, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, ObservableSource<? extends T> var2) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      ObjectHelper.requireNonNull(var2, "source3 is null");
      return fromArray(var0, var1, var2).flatMap(Functions.identity(), false, 3);
   }
   ...
   public static <T> Observable<T> merge(
      ...
      ObjectHelper.requireNonNull(var2, "source3 is null");
      ObjectHelper.requireNonNull(var3, "source4 is null");
      return fromArray(var0, var1, var2, var3).flatMap(Functions.identity(), false, 4);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> var0) {
      return fromIterable(var0).flatMap(Functions.identity());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> var0, int var1) {
      return fromIterable(var0).flatMap(Functions.identity(), var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> var0, int var1, int var2) {
      return fromIterable(var0).flatMap(Functions.identity(), false, var1, var2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeArray(int var0, int var1, ObservableSource<? extends T>... var2) {
      return fromArray(var2).flatMap(Functions.identity(), false, var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeArray(ObservableSource<? extends T>... var0) {
      return fromArray(var0).flatMap(Functions.identity(), var0.length);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeArrayDelayError(int var0, int var1, ObservableSource<? extends T>... var2) {
      return fromArray(var2).flatMap(Functions.identity(), true, var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeArrayDelayError(ObservableSource<? extends T>... var0) {
      return fromArray(var0).flatMap(Functions.identity(), true, var0.length);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      ObjectHelper.verifyPositive(var1, "maxConcurrency");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      return fromArray(var0, var1).flatMap(Functions.identity(), true, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, ObservableSource<? extends T> var2) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      ObjectHelper.requireNonNull(var2, "source3 is null");
      return fromArray(var0, var1, var2).flatMap(Functions.identity(), true, 3);
   }
   ...
   public static <T> Observable<T> mergeDelayError(
      ...
      ObjectHelper.requireNonNull(var2, "source3 is null");
      ObjectHelper.requireNonNull(var3, "source4 is null");
      return fromArray(var0, var1, var2, var3).flatMap(Functions.identity(), true, 4);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> var0) {
      return fromIterable(var0).flatMap(Functions.identity(), true);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> var0, int var1) {
      return fromIterable(var0).flatMap(Functions.identity(), true, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> var0, int var1, int var2) {
   ...
   public static Observable<Integer> range(int var0, int var1) {
      if (var1 >= 0) {
         if (var1 == 0) {
            ...
            return just(var0);
         } else if ((long)var0 + (var1 - 1) <= 2147483647L) {
            return RxJavaPlugins.onAssembly(new ObservableRange(var0, var1));
         } else {
            throw new IllegalArgumentException("Integer overflow");
         }
      } else {
         StringBuilder var2 = new StringBuilder("count >= 0 required but it was ");
         var2.append(var1);
   ...
   public static Observable<Long> rangeLong(long var0, long var2) {
      long var6;
      int var4 = (var6 = var2 - 0L) == 0L ? 0 : (var6 < 0L ? -1 : 1);
      if (var4 >= 0) {
         if (var4 == 0) {
            return empty();
         } else if (var2 == 1L) {
            return just(var0);
         } else if (var0 > 0L && var2 - 1L + var0 < 0L) {
            throw new IllegalArgumentException("Overflow! start + count is bigger than Long.MAX_VALUE");
         } else {
            return RxJavaPlugins.onAssembly(new ObservableRangeLong(var0, var2));
         }
      } else {
         StringBuilder var5 = new StringBuilder("count >= 0 required but it was ");
         var5.append(var2);
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Single<Boolean> sequenceEqual(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1) {
      return sequenceEqual(var0, var1, ObjectHelper.equalsPredicate(), bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Single<Boolean> sequenceEqual(ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, int var2) {
   ...
   public static <T> Single<Boolean> sequenceEqual(
      ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, BiPredicate<? super T, ? super T> var2
   ) {
   ...
   @SchedulerSupport("none")
   public static <T> Single<Boolean> sequenceEqual(
      ObservableSource<? extends T> var0, ObservableSource<? extends T> var1, BiPredicate<? super T, ? super T> var2, int var3
   ) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> switchOnNext(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      return switchOnNext(var0, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> switchOnNext(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1) {
      ObjectHelper.requireNonNull(var0, "sources is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> switchOnNextDelayError(ObservableSource<? extends ObservableSource<? extends T>> var0) {
      return switchOnNextDelayError(var0, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> switchOnNextDelayError(ObservableSource<? extends ObservableSource<? extends T>> var0, int var1) {
      ObjectHelper.requireNonNull(var0, "sources is null");
      ObjectHelper.verifyPositive(var1, "prefetch");
   ...
   private <U, V> Observable<T> timeout0(ObservableSource<U> var1, Function<? super T, ? extends ObservableSource<V>> var2, ObservableSource<? extends T> var3) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> unsafeCreate(ObservableSource<T> var0) {
   ...
   public static <T, D> Observable<T> using(
      Callable<? extends D> var0, Function<? super D, ? extends ObservableSource<? extends T>> var1, Consumer<? super D> var2
   ) {
   ...
   @SchedulerSupport("none")
   public static <T, D> Observable<T> using(
      Callable<? extends D> var0, Function<? super D, ? extends ObservableSource<? extends T>> var1, Consumer<? super D> var2, boolean var3
   ) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T> Observable<T> wrap(ObservableSource<T> var0) {
      ObjectHelper.requireNonNull(var0, "source is null");
      return var0 instanceof Observable ? RxJavaPlugins.onAssembly((Observable<T>)var0) : RxJavaPlugins.onAssembly(new ObservableFromUnsafeSource<>(var0));
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var7, "source8 is null");
      ObjectHelper.requireNonNull(var8, "source9 is null");
      return zipArray(Functions.toFunction(var9), false, bufferSize(), var0, var1, var2, var3, var4, var5, var6, var7, var8);
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var6, "source7 is null");
      ObjectHelper.requireNonNull(var7, "source8 is null");
      return zipArray(Functions.toFunction(var8), false, bufferSize(), var0, var1, var2, var3, var4, var5, var6, var7);
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, T7, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var5, "source6 is null");
      ObjectHelper.requireNonNull(var6, "source7 is null");
      return zipArray(Functions.toFunction(var7), false, bufferSize(), var0, var1, var2, var3, var4, var5, var6);
   }
   ...
   public static <T1, T2, T3, T4, T5, T6, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var4, "source5 is null");
      ObjectHelper.requireNonNull(var5, "source6 is null");
      return zipArray(Functions.toFunction(var6), false, bufferSize(), var0, var1, var2, var3, var4, var5);
   }
   ...
   public static <T1, T2, T3, T4, T5, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var3, "source4 is null");
      ObjectHelper.requireNonNull(var4, "source5 is null");
      return zipArray(Functions.toFunction(var5), false, bufferSize(), var0, var1, var2, var3, var4);
   }
   ...
   public static <T1, T2, T3, T4, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var2, "source3 is null");
      ObjectHelper.requireNonNull(var3, "source4 is null");
      return zipArray(Functions.toFunction(var4), false, bufferSize(), var0, var1, var2, var3);
   }
   ...
   public static <T1, T2, T3, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var1, "source2 is null");
      ObjectHelper.requireNonNull(var2, "source3 is null");
      return zipArray(Functions.toFunction(var3), false, bufferSize(), var0, var1, var2);
   }
   ...
   public static <T1, T2, R> Observable<R> zip(
      ...
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      return zipArray(Functions.toFunction(var2), false, bufferSize(), var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T1, T2, R> Observable<R> zip(
      ObservableSource<? extends T1> var0, ObservableSource<? extends T2> var1, BiFunction<? super T1, ? super T2, ? extends R> var2, boolean var3
   ) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      return zipArray(Functions.toFunction(var2), var3, bufferSize(), var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T1, T2, R> Observable<R> zip(
      ObservableSource<? extends T1> var0, ObservableSource<? extends T2> var1, BiFunction<? super T1, ? super T2, ? extends R> var2, boolean var3, int var4
   ) {
      ObjectHelper.requireNonNull(var0, "source1 is null");
      ObjectHelper.requireNonNull(var1, "source2 is null");
      return zipArray(Functions.toFunction(var2), var3, var4, var0, var1);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> zip(ObservableSource<? extends ObservableSource<? extends T>> var0, Function<? super Object[], ? extends R> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> zip(Iterable<? extends ObservableSource<? extends T>> var0, Function<? super Object[], ? extends R> var1) {
      ObjectHelper.requireNonNull(var1, "zipper is null");
      ObjectHelper.requireNonNull(var0, "sources is null");
      return RxJavaPlugins.onAssembly(new ObservableZip<>(null, var0, var1, bufferSize(), false));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public static <T, R> Observable<R> zipArray(Function<? super Object[], ? extends R> var0, boolean var1, int var2, ObservableSource<? extends T>... var3) {
      if (var3.length == 0) {
         return empty();
      } else {
         ObjectHelper.requireNonNull(var0, "zipper is null");
         ObjectHelper.verifyPositive(var2, "bufferSize");
         return RxJavaPlugins.onAssembly(new ObservableZip<>(var3, null, var0, var2, var1));
      }
   }
   ...
   public static <T, R> Observable<R> zipIterable(
      Iterable<? extends ObservableSource<? extends T>> var0, Function<? super Object[], ? extends R> var1, boolean var2, int var3
   ) {
      ObjectHelper.requireNonNull(var1, "zipper is null");
      ObjectHelper.requireNonNull(var0, "sources is null");
      ObjectHelper.verifyPositive(var3, "bufferSize");
      return RxJavaPlugins.onAssembly(new ObservableZip<>(null, var0, var1, var3, var2));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> R as(ObservableConverter<T, ? extends R> var1) {
   ...
   public final Iterable<T> blockingMostRecent(T var1) {
      return new BlockingObservableMostRecent<>(this, (T)var1);
   }
   ...
   public final T blockingSingle(T var1) {
      return this.single((T)var1).blockingGet();
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U extends Collection<? super T>> Observable<U> buffer(int var1, int var2, Callable<U> var3) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U extends Collection<? super T>> Observable<U> buffer(int var1, Callable<U> var2) {
   ...
   @CheckReturnValue
   @SchedulerSupport("custom")
   public final <U extends Collection<? super T>> Observable<U> buffer(long var1, long var3, TimeUnit var5, Scheduler var6, Callable<U> var7) {
   ...
   @CheckReturnValue
   @SchedulerSupport("custom")
   public final <U extends Collection<? super T>> Observable<U> buffer(long var1, TimeUnit var3, Scheduler var4, int var5, Callable<U> var6, boolean var7) {
      ObjectHelper.requireNonNull(var3, "unit is null");
      ObjectHelper.requireNonNull(var4, "scheduler is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<List<T>> buffer(ObservableSource<B> var1) {
      return this.buffer(var1, ArrayListSupplier.asCallable());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<List<T>> buffer(ObservableSource<B> var1, int var2) {
   ...
   public final <TOpening, TClosing> Observable<List<T>> buffer(
      ObservableSource<? extends TOpening> var1, Function<? super TOpening, ? extends ObservableSource<? extends TClosing>> var2
   ) {
      return this.buffer(var1, var2, ArrayListSupplier.asCallable());
   }
   ...
   public final <TOpening, TClosing, U extends Collection<? super T>> Observable<U> buffer(
      ObservableSource<? extends TOpening> var1, Function<? super TOpening, ? extends ObservableSource<? extends TClosing>> var2, Callable<U> var3
   ) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B, U extends Collection<? super T>> Observable<U> buffer(ObservableSource<B> var1, Callable<U> var2) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<List<T>> buffer(Callable<? extends ObservableSource<B>> var1) {
      return this.buffer(var1, ArrayListSupplier.asCallable());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B, U extends Collection<? super T>> Observable<U> buffer(Callable<? extends ObservableSource<B>> var1, Callable<U> var2) {
   ...
   public final Observable<T> cacheWithInitialCapacity(int var1) {
      ...
      return RxJavaPlugins.onAssembly(new ObservableCache<>(this, var1));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<U> cast(Class<U> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Single<U> collect(Callable<? extends U> var1, BiConsumer<? super U, ? super T> var2) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Single<U> collectInto(U var1, BiConsumer<? super U, ? super T> var2) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> compose(ObservableTransformer<? super T, ? extends R> var1) {
      return wrap(ObjectHelper.requireNonNull(var1, "composer is null").apply(this));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1) {
      return this.concatMap(var1, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2) {
   ...
   public final Completable concatMapCompletable(Function<? super T, ? extends CompletableSource> var1, int var2) {
      ...
      return RxJavaPlugins.onAssembly(new ObservableConcatMapCompletable<>(this, var1, ErrorMode.IMMEDIATE, var2));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> var1) {
      return this.concatMapCompletableDelayError(var1, true, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> var1, boolean var2) {
      return this.concatMapCompletableDelayError(var1, var2, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> var1, boolean var2, int var3) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ...
      return RxJavaPlugins.onAssembly(new ObservableConcatMapCompletable<>(this, var1, var4, var3));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> var1) {
      return this.concatMapDelayError(var1, bufferSize(), true);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2, boolean var3) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "prefetch");
      if (this instanceof ScalarCallable) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapEager(Function<? super T, ? extends ObservableSource<? extends R>> var1) {
      return this.concatMapEager(var1, Integer.MAX_VALUE, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapEager(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2, int var3) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2, int var3, boolean var4) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "maxConcurrency");
      ObjectHelper.verifyPositive(var3, "prefetch");
      ErrorMode var5;
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> var1, boolean var2) {
      return this.concatMapEagerDelayError(var1, Integer.MAX_VALUE, bufferSize(), var2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<U> concatMapIterable(Function<? super T, ? extends Iterable<? extends U>> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<U> concatMapIterable(Function<? super T, ? extends Iterable<? extends U>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "prefetch");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> var1) {
      return this.concatMapMaybe(var1, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "prefetch");
      return RxJavaPlugins.onAssembly(new ObservableConcatMapMaybe<>(this, var1, ErrorMode.IMMEDIATE, var2));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> var1) {
      return this.concatMapMaybeDelayError(var1, true, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> var1, boolean var2) {
      return this.concatMapMaybeDelayError(var1, var2, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> var1, boolean var2, int var3) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var3, "prefetch");
      ErrorMode var4;
      if (var2) {
      ...
      return RxJavaPlugins.onAssembly(new ObservableConcatMapMaybe<>(this, var1, var4, var3));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> var1) {
      return this.concatMapSingle(var1, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "prefetch");
      return RxJavaPlugins.onAssembly(new ObservableConcatMapSingle<>(this, var1, ErrorMode.IMMEDIATE, var2));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> var1) {
      return this.concatMapSingleDelayError(var1, true, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> var1, boolean var2) {
      return this.concatMapSingleDelayError(var1, var2, 2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> var1, boolean var2, int var3) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var3, "prefetch");
      ErrorMode var4;
      if (var2) {
      ...
      return RxJavaPlugins.onAssembly(new ObservableConcatMapSingle<>(this, var1, var4, var3));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Observable<T> concatWith(CompletableSource var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
      return RxJavaPlugins.onAssembly(new ObservableConcatWithCompletable<>(this, var1));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Observable<T> concatWith(MaybeSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
      return RxJavaPlugins.onAssembly(new ObservableConcatWithMaybe<>(this, var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final Observable<T> concatWith(SingleSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
      return RxJavaPlugins.onAssembly(new ObservableConcatWithSingle<>(this, var1));
   }
   ...
   public final Single<Boolean> contains(Object var1) {
      ...
      return this.any(Functions.equalsWith((T)var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> debounce(Function<? super T, ? extends ObservableSource<U>> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, V> Observable<T> delay(ObservableSource<U> var1, Function<? super T, ? extends ObservableSource<V>> var2) {
      return this.delaySubscription(var1).delay(var2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> delay(Function<? super T, ? extends ObservableSource<U>> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> delaySubscription(ObservableSource<U> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> dematerialize(Function<? super T, Notification<R>> var1) {
      ObjectHelper.requireNonNull(var1, "selector is null");
      return RxJavaPlugins.onAssembly(new ObservableDematerialize<>(this, var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Observable<T> distinct(Function<? super T, K> var1) {
      return this.distinct(var1, Functions.createHashSet());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Observable<T> distinct(Function<? super T, K> var1, Callable<? extends Collection<? super K>> var2) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Observable<T> distinctUntilChanged(Function<? super T, K> var1) {
      ObjectHelper.requireNonNull(var1, "keySelector is null");
   ...
   public final Observable<T> doOnEach(Observer<? super T> var1) {
      ...
      return this.doOnEach(
         ObservableInternalHelper.observerOnNext(var1),
         ObservableInternalHelper.observerOnError(var1),
         ObservableInternalHelper.observerOnComplete(var1),
   ...
   public final Observable<T> doOnEach(Consumer<? super Notification<T>> var1) {
      ObjectHelper.requireNonNull(var1, "onNotification is null");
      return this.doOnEach(
         Functions.notificationOnNext(var1), Functions.notificationOnError(var1), Functions.notificationOnComplete(var1), Functions.EMPTY_ACTION
      );
   }
   ...
   public final Maybe<T> elementAt(long var1) {
      if (var1 >= 0L) {
         ...
         StringBuilder var3 = new StringBuilder("index >= 0 required but it was ");
         var3.append(var1);
   ...
   public final Single<T> elementAt(long var1, T var3) {
      if (var1 >= 0L) {
         ...
         return RxJavaPlugins.onAssembly(new ObservableElementAtSingle<>(this, var1, (T)var3));
      } else {
         var3 = new StringBuilder("index >= 0 required but it was ");
         var3.append(var1);
         throw new IndexOutOfBoundsException(var3.toString());
      }
   }
   ...
   public final Single<T> elementAtOrError(long var1) {
      if (var1 >= 0L) {
         return RxJavaPlugins.onAssembly(new ObservableElementAtSingle<>(this, var1, null));
      } else {
         StringBuilder var3 = new StringBuilder("index >= 0 required but it was ");
         var3.append(var1);
         throw new IndexOutOfBoundsException(var3.toString());
   ...
   public final Single<T> first(T var1) {
      return this.elementAt(0L, (T)var1);
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1) {
      return this.flatMap(var1, false);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2) {
   ...
   public final <U, R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends U>> var1, BiFunction<? super T, ? super U, ? extends R> var2
   ) {
   ...
   @SchedulerSupport("none")
   public final <U, R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends U>> var1, BiFunction<? super T, ? super U, ? extends R> var2, int var3
   ) {
   ...
   @SchedulerSupport("none")
   public final <U, R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends U>> var1, BiFunction<? super T, ? super U, ? extends R> var2, boolean var3
   ) {
   ...
   @SchedulerSupport("none")
   public final <U, R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends U>> var1, BiFunction<? super T, ? super U, ? extends R> var2, boolean var3, int var4
   ) {
   ...
   @SchedulerSupport("none")
   public final <U, R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends U>> var1, BiFunction<? super T, ? super U, ? extends R> var2, boolean var3, int var4, int var5
   ) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   public final <R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends R>> var1,
      Function<? super Throwable, ? extends ObservableSource<? extends R>> var2,
      Callable<? extends ObservableSource<? extends R>> var3
   ) {
      ...
      return merge(new ObservableMapNotification<>(this, var1, var2, var3));
   }
   ...
   public final <R> Observable<R> flatMap(
      Function<? super T, ? extends ObservableSource<? extends R>> var1,
      Function<Throwable, ? extends ObservableSource<? extends R>> var2,
      Callable<? extends ObservableSource<? extends R>> var3,
      int var4
   ) {
      ObjectHelper.requireNonNull(var1, "onNextMapper is null");
      ObjectHelper.requireNonNull(var2, "onErrorMapper is null");
      ObjectHelper.requireNonNull(var3, "onCompleteSupplier is null");
      return merge(new ObservableMapNotification<>(this, var1, var2, var3), var4);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1, boolean var2) {
      return this.flatMap(var1, var2, Integer.MAX_VALUE);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1, boolean var2, int var3) {
      return this.flatMap(var1, var2, var3, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> var1, boolean var2, int var3, int var4) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<U> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableFlattenIterable<>(this, var1));
   }
   ...
   public final <U, V> Observable<V> flatMapIterable(
      Function<? super T, ? extends Iterable<? extends U>> var1, BiFunction<? super T, ? super U, ? extends V> var2
   ) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> var1) {
      return this.flatMapMaybe(var1, false);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> var1, boolean var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> var1) {
      return this.flatMapSingle(var1, false);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> var1, boolean var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> var1) {
      return this.groupBy(var1, Functions.identity(), false, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2) {
      return this.groupBy(var1, var2, false, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2, boolean var3) {
   ...
   public final <K, V> Observable<GroupedObservable<K, V>> groupBy(
      Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2, boolean var3, int var4
   ) {
      ObjectHelper.requireNonNull(var1, "keySelector is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> var1, boolean var2) {
   ...
   public final <TRight, TLeftEnd, TRightEnd, R> Observable<R> groupJoin(
      ObservableSource<? extends TRight> var1,
      Function<? super T, ? extends ObservableSource<TLeftEnd>> var2,
      Function<? super TRight, ? extends ObservableSource<TRightEnd>> var3,
      BiFunction<? super T, ? super Observable<TRight>, ? extends R> var4
   ) {
      ObjectHelper.requireNonNull(var1, "other is null");
   ...
   public final <TRight, TLeftEnd, TRightEnd, R> Observable<R> join(
      ...
      Function<? super T, ? extends ObservableSource<TLeftEnd>> var2,
      Function<? super TRight, ? extends ObservableSource<TRightEnd>> var3,
      BiFunction<? super T, ? super TRight, ? extends R> var4
   ) {
      ObjectHelper.requireNonNull(var1, "other is null");
      ObjectHelper.requireNonNull(var2, "leftEnd is null");
      ObjectHelper.requireNonNull(var3, "rightEnd is null");
   ...
   public final Single<T> last(T var1) {
      ObjectHelper.requireNonNull(var1, "defaultItem is null");
      return RxJavaPlugins.onAssembly(new ObservableLastSingle<>(this, (T)var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> lift(ObservableOperator<? extends R, ? super T> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> map(Function<? super T, ? extends R> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final Observable<T> mergeWith(CompletableSource var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
      return RxJavaPlugins.onAssembly(new ObservableMergeWithCompletable<>(this, var1));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Observable<T> mergeWith(MaybeSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
      return RxJavaPlugins.onAssembly(new ObservableMergeWithMaybe<>(this, var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final Observable<T> mergeWith(SingleSource<? extends T> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
      return RxJavaPlugins.onAssembly(new ObservableMergeWithSingle<>(this, var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<U> ofType(Class<U> var1) {
      ObjectHelper.requireNonNull(var1, "clazz is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> publish(Function<? super Observable<T>, ? extends ObservableSource<R>> var1) {
      ObjectHelper.requireNonNull(var1, "selector is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Single<R> reduce(R var1, BiFunction<R, ? super T, R> var2) {
      ObjectHelper.requireNonNull(var1, "seed is null");
      ObjectHelper.requireNonNull(var2, "reducer is null");
      return (Single<R>)RxJavaPlugins.onAssembly(new ObservableReduceSeedSingle<>(this, var1, var2));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Single<R> reduceWith(Callable<R> var1, BiFunction<R, ? super T, R> var2) {
   ...
   public final Observable<T> repeat(long var1) {
      long var5;
      int var3 = (var5 = var1 - 0L) == 0L ? 0 : (var5 < 0L ? -1 : 1);
      if (var3 >= 0) {
         return var3 == 0 ? empty() : RxJavaPlugins.onAssembly(new ObservableRepeat<>(this, var1));
      } else {
         StringBuilder var4 = new StringBuilder("times >= 0 required but it was ");
         var4.append(var1);
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1) {
      ObjectHelper.requireNonNull(var1, "selector is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "selector is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
   ...
   @CheckReturnValue
   @SchedulerSupport("io.reactivex:computation")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1, int var2, long var3, TimeUnit var5) {
   ...
   public final <R> Observable<R> replay(
      Function<? super Observable<T>, ? extends ObservableSource<R>> var1, int var2, long var3, TimeUnit var5, Scheduler var6
   ) {
      ObjectHelper.requireNonNull(var1, "selector is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
      ObjectHelper.requireNonNull(var5, "unit is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("custom")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1, int var2, Scheduler var3) {
      ObjectHelper.requireNonNull(var1, "selector is null");
      ObjectHelper.requireNonNull(var3, "scheduler is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
   ...
   @CheckReturnValue
   @SchedulerSupport("io.reactivex:computation")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1, long var2, TimeUnit var4) {
      return this.replay(var1, var2, var4, Schedulers.computation());
   }

   @CheckReturnValue
   @SchedulerSupport("custom")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1, long var2, TimeUnit var4, Scheduler var5) {
      ObjectHelper.requireNonNull(var1, "selector is null");
      ObjectHelper.requireNonNull(var4, "unit is null");
      ObjectHelper.requireNonNull(var5, "scheduler is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("custom")
   public final <R> Observable<R> replay(Function<? super Observable<T>, ? extends ObservableSource<R>> var1, Scheduler var2) {
      ObjectHelper.requireNonNull(var1, "selector is null");
   ...
   public final void safeSubscribe(Observer<? super T> var1) {
      ...
      if (var1 instanceof SafeObserver) {
         ...
         this.subscribe(new SafeObserver<>(var1));
      }
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> sample(ObservableSource<U> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> sample(ObservableSource<U> var1, boolean var2) {
      ObjectHelper.requireNonNull(var1, "sampler is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> scan(R var1, BiFunction<R, ? super T, R> var2) {
      ObjectHelper.requireNonNull(var1, "initialValue is null");
      return this.scanWith((Callable<R>)Functions.justCallable(var1), var2);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> scanWith(Callable<R> var1, BiFunction<R, ? super T, R> var2) {
      ObjectHelper.requireNonNull(var1, "seedSupplier is null");
   ...
   public final Single<T> single(T var1) {
      ObjectHelper.requireNonNull(var1, "defaultItem is null");
      return RxJavaPlugins.onAssembly(new ObservableSingleSingle<>(this, (T)var1));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> skipUntil(ObservableSource<U> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
   ...
   public final Observable<T> startWith(Iterable<? extends T> var1) {
      return concatArray(fromIterable(var1), this);
   }
   ...
   public final Observable<T> startWith(T var1) {
      ObjectHelper.requireNonNull(var1, "item is null");
      return concatArray(just(var1), this);
   }
   ...
   public final Observable<T> startWithArray(T... var1) {
      ...
      return var2 == empty() ? RxJavaPlugins.onAssembly(this) : concatArray(var2, this);
   }
   ...
   public final void subscribe(Observer<? super T> var1) {
      ...
      try {
         ...
         NullPointerException var7 = new NullPointerException("Actually not, but can't throw other exceptions due to RS");
         var7.initCause(var6);
         throw var7;
      }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <E extends Observer<? super T>> E subscribeWith(E var1) {
      this.subscribe(var1);
      return (E)var1;
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMap(Function<? super T, ? extends ObservableSource<? extends R>> var1) {
      return this.switchMap(var1, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMap(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
      if (this instanceof ScalarCallable) {
         Object var3 = ((ScalarCallable)this).call();
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final Completable switchMapCompletable(Function<? super T, ? extends CompletableSource> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableSwitchMapCompletable<>(this, var1, false));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final Completable switchMapCompletableDelayError(Function<? super T, ? extends CompletableSource> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableSwitchMapCompletable<>(this, var1, true));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> var1) {
      return this.switchMapDelayError(var1, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
      if (this instanceof ScalarCallable) {
         Object var3 = ((ScalarCallable)this).call();
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableSwitchMapMaybe<>(this, var1, false));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableSwitchMapMaybe<>(this, var1, true));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMapSingle(Function<? super T, ? extends SingleSource<? extends R>> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableSwitchMapSingle<>(this, var1, false));
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> switchMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> var1) {
      ObjectHelper.requireNonNull(var1, "mapper is null");
      return RxJavaPlugins.onAssembly(new ObservableSwitchMapSingle<>(this, var1, true));
   }
   ...
   public final Observable<T> take(long var1) {
      if (var1 >= 0L) {
         ...
         StringBuilder var3 = new StringBuilder("count >= 0 required but it was ");
         var3.append(var1);
   ...
   public final Observable<T> take(long var1, TimeUnit var3) {
      return this.takeUntil(timer(var1, var3));
   }

   @CheckReturnValue
   @SchedulerSupport("custom")
   public final Observable<T> take(long var1, TimeUnit var3, Scheduler var4) {
      return this.takeUntil(timer(var1, var3, var4));
   }
   ...
   public final Observable<T> takeLast(int var1) {
      if (var1 >= 0) {
         if (var1 == 0) {
            ...
            return var1 == 1 ? RxJavaPlugins.onAssembly(new ObservableTakeLastOne<>(this)) : RxJavaPlugins.onAssembly(new ObservableTakeLast<>(this, var1));
         }
      } else {
         StringBuilder var2 = new StringBuilder("count >= 0 required but it was ");
         var2.append(var1);
   ...
   public final Observable<T> takeLast(long var1, long var3, TimeUnit var5, Scheduler var6, boolean var7, int var8) {
      ...
      if (var1 >= 0L) {
         ...
         StringBuilder var9 = new StringBuilder("count >= 0 required but it was ");
         var9.append(var1);
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U> Observable<T> takeUntil(ObservableSource<U> var1) {
      ObjectHelper.requireNonNull(var1, "other is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("io.reactivex:computation")
   public final Observable<T> throttleLatest(long var1, TimeUnit var3) {
      return this.throttleLatest(var1, var3, Schedulers.computation(), false);
   }

   @CheckReturnValue
   @SchedulerSupport("custom")
   public final Observable<T> throttleLatest(long var1, TimeUnit var3, Scheduler var4) {
      return this.throttleLatest(var1, var3, var4, false);
   }

   @CheckReturnValue
   @SchedulerSupport("custom")
   public final Observable<T> throttleLatest(long var1, TimeUnit var3, Scheduler var4, boolean var5) {
      ObjectHelper.requireNonNull(var3, "unit is null");
      ObjectHelper.requireNonNull(var4, "scheduler is null");
      return RxJavaPlugins.onAssembly(new ObservableThrottleLatest<>(this, var1, var3, var4, var5));
   }

   @CheckReturnValue
   @SchedulerSupport("io.reactivex:computation")
   public final Observable<T> throttleLatest(long var1, TimeUnit var3, boolean var4) {
      return this.throttleLatest(var1, var3, Schedulers.computation(), var4);
   }
   ...
   public final Observable<T> timeout(long var1, TimeUnit var3) {
      return this.timeout0(var1, var3, null, Schedulers.computation());
   }
   ...
   public final Observable<T> timeout(long var1, TimeUnit var3, Scheduler var4) {
      return this.timeout0(var1, var3, null, var4);
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, V> Observable<T> timeout(ObservableSource<U> var1, Function<? super T, ? extends ObservableSource<V>> var2) {
      ObjectHelper.requireNonNull(var1, "firstTimeoutIndicator is null");
      return this.timeout0(var1, var2, null);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, V> Observable<T> timeout(
      ObservableSource<U> var1, Function<? super T, ? extends ObservableSource<V>> var2, ObservableSource<? extends T> var3
   ) {
      ObjectHelper.requireNonNull(var1, "firstTimeoutIndicator is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <V> Observable<T> timeout(Function<? super T, ? extends ObservableSource<V>> var1) {
      return this.timeout0(null, var1, null);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <V> Observable<T> timeout(Function<? super T, ? extends ObservableSource<V>> var1, ObservableSource<? extends T> var2) {
      ObjectHelper.requireNonNull(var2, "other is null");
      return this.timeout0(null, var1, var2);
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> R to(Function<? super Observable<T>, R> var1) {
      try {
         return (R)ObjectHelper.requireNonNull(var1, "converter is null").apply(this);
   ...
   public final Flowable<T> toFlowable(BackpressureStrategy var1) {
      FlowableFromObservable var3 = new FlowableFromObservable<>(this);
      int var2 = <unrepresentable>.$SwitchMap$io$reactivex$BackpressureStrategy[var1.ordinal()];
      if (var2 != 1) {
         if (var2 != 2) {
            if (var2 != 3) {
               return var2 != 4 ? var3.onBackpressureBuffer() : RxJavaPlugins.onAssembly(new FlowableOnBackpressureError<>(var3));
            } else {
               return var3;
            }
         } else {
            return var3.onBackpressureLatest();
         }
      } else {
         return var3.onBackpressureDrop();
      }
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U extends Collection<? super T>> Single<U> toList(Callable<U> var1) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Single<Map<K, T>> toMap(Function<? super T, ? extends K> var1) {
      ObjectHelper.requireNonNull(var1, "keySelector is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K, V> Single<Map<K, V>> toMap(Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2) {
      ObjectHelper.requireNonNull(var1, "keySelector is null");
      ObjectHelper.requireNonNull(var2, "valueSelector is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K, V> Single<Map<K, V>> toMap(Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2, Callable<? extends Map<K, V>> var3) {
      ObjectHelper.requireNonNull(var1, "keySelector is null");
      ObjectHelper.requireNonNull(var2, "valueSelector is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K> Single<Map<K, Collection<T>>> toMultimap(Function<? super T, ? extends K> var1) {
      return this.toMultimap(var1, Functions.identity(), HashMapSupplier.asCallable(), ArrayListSupplier.asFunction());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <K, V> Single<Map<K, Collection<V>>> toMultimap(Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2) {
   ...
   public final <K, V> Single<Map<K, Collection<V>>> toMultimap(
      Function<? super T, ? extends K> var1, Function<? super T, ? extends V> var2, Callable<Map<K, Collection<V>>> var3
   ) {
   ...
   @SchedulerSupport("none")
   public final <K, V> Single<Map<K, Collection<V>>> toMultimap(
      Function<? super T, ? extends K> var1,
      Function<? super T, ? extends V> var2,
      Callable<? extends Map<K, Collection<V>>> var3,
      Function<? super K, ? extends Collection<? super V>> var4
   ) {
      ObjectHelper.requireNonNull(var1, "keySelector is null");
      ObjectHelper.requireNonNull(var2, "valueSelector is null");
      ObjectHelper.requireNonNull(var3, "mapSupplier is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<Observable<T>> window(ObservableSource<B> var1) {
      return this.window(var1, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<Observable<T>> window(ObservableSource<B> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "boundary is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, V> Observable<Observable<T>> window(ObservableSource<U> var1, Function<? super U, ? extends ObservableSource<V>> var2) {
      return this.window(var1, var2, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, V> Observable<Observable<T>> window(ObservableSource<U> var1, Function<? super U, ? extends ObservableSource<V>> var2, int var3) {
      ObjectHelper.requireNonNull(var1, "openingIndicator is null");
      ObjectHelper.requireNonNull(var2, "closingIndicator is null");
      ObjectHelper.verifyPositive(var3, "bufferSize");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<Observable<T>> window(Callable<? extends ObservableSource<B>> var1) {
      return this.window(var1, bufferSize());
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <B> Observable<Observable<T>> window(Callable<? extends ObservableSource<B>> var1, int var2) {
      ObjectHelper.requireNonNull(var1, "boundary is null");
      ObjectHelper.verifyPositive(var2, "bufferSize");
   ...
   public final <T1, T2, T3, T4, R> Observable<R> withLatestFrom(
      ObservableSource<T1> var1,
      ObservableSource<T2> var2,
      ObservableSource<T3> var3,
      ObservableSource<T4> var4,
      Function5<? super T, ? super T1, ? super T2, ? super T3, ? super T4, R> var5
   ) {
   ...
   public final <T1, T2, T3, R> Observable<R> withLatestFrom(
      ObservableSource<T1> var1, ObservableSource<T2> var2, ObservableSource<T3> var3, Function4<? super T, ? super T1, ? super T2, ? super T3, R> var4
   ) {
      ObjectHelper.requireNonNull(var1, "o1 is null");
      ObjectHelper.requireNonNull(var2, "o2 is null");
      ObjectHelper.requireNonNull(var3, "o3 is null");
   ...
   public final <T1, T2, R> Observable<R> withLatestFrom(
      ObservableSource<T1> var1, ObservableSource<T2> var2, Function3<? super T, ? super T1, ? super T2, R> var3
   ) {
      ObjectHelper.requireNonNull(var1, "o1 is null");
      ObjectHelper.requireNonNull(var2, "o2 is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, R> Observable<R> withLatestFrom(ObservableSource<? extends U> var1, BiFunction<? super T, ? super U, ? extends R> var2) {
      ObjectHelper.requireNonNull(var1, "other is null");
      ObjectHelper.requireNonNull(var2, "combiner is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> withLatestFrom(Iterable<? extends ObservableSource<?>> var1, Function<? super Object[], R> var2) {
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <R> Observable<R> withLatestFrom(ObservableSource<?>[] var1, Function<? super Object[], R> var2) {
      ObjectHelper.requireNonNull(var1, "others is null");
      ObjectHelper.requireNonNull(var2, "combiner is null");
      return RxJavaPlugins.onAssembly(new ObservableWithLatestFromMany<>(this, var1, var2));
   }
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> var1, BiFunction<? super T, ? super U, ? extends R> var2) {
      ObjectHelper.requireNonNull(var1, "other is null");
   ...
   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> var1, BiFunction<? super T, ? super U, ? extends R> var2, boolean var3) {
      return zip(this, var1, var2, var3);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> var1, BiFunction<? super T, ? super U, ? extends R> var2, boolean var3, int var4) {
      return zip(this, var1, var2, var3, var4);
   }

   @CheckReturnValue
   @SchedulerSupport("none")
   public final <U, R> Observable<R> zipWith(Iterable<U> var1, BiFunction<? super T, ? super U, ? extends R> var2) {
      ObjectHelper.requireNonNull(var1, "other is null");
