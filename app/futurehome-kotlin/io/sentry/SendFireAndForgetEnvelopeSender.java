...
public final class SendFireAndForgetEnvelopeSender implements SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForgetFactory {
   ...
   public SendFireAndForgetEnvelopeSender(SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForgetDirPath var1) {
   ...
   public SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForget create(IHub var1, SentryOptions var2) {
      ...
      if (var3 != null && this.hasValidPath(var3, var2.getLogger())) {
         return this.processDir(
            new EnvelopeSender(var1, var2.getSerializer(), var2.getLogger(), var2.getFlushTimeoutMillis(), var2.getMaxQueueSize()), var3, var2.getLogger()
         );
      } else {
