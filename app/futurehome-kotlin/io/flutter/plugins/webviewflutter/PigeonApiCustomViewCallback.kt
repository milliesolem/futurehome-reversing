...
public abstract class PigeonApiCustomViewCallback {
   ...
   open fun PigeonApiCustomViewCallback(var1: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
   ...
   public abstract fun onCustomViewHidden(pigeon_instance: CustomViewCallback) {
   }

   public fun pigeon_newInstance(pigeon_instanceArg: CustomViewCallback, callback: (Result<Unit>) -> Unit) {
      if (this.getPigeonRegistrar().getIgnoreCallsToDart()) {
         ...
         new BasicMessageChannel<>(
            ...
            .send(
               ...
               new PigeonApiCustomViewCallback$$ExternalSyntheticLambda0(
                  var2, "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.pigeon_newInstance"
               )
            );
      }
   }
   ...
   public companion object {
      ...
      @JvmStatic
      fun `setUpMessageHandlers$lambda$1$lambda$0`(var0: PigeonApiCustomViewCallback, var1: Any, var2: BasicMessageChannel.Reply) {
         var1 = (var1 as java.util.List).get(0);
         var1 = var1 as CustomViewCallback;

         label12:
         try {
            var0.onCustomViewHidden(var1);
      ...
      public fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiCustomViewCallback?) {
         ...
         val var7: PigeonApiCustomViewCallback.Companion = this;
         val var5: BasicMessageChannel = new BasicMessageChannel(var1, "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.onCustomViewHidden", var6);
         if (var2 != null) {
            var5.setMessageHandler(new PigeonApiCustomViewCallback$Companion$$ExternalSyntheticLambda0(var2));
         } else {
