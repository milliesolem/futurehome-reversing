...
public abstract class PigeonApiHttpAuthHandler {
   ...
   open fun PigeonApiHttpAuthHandler(var1: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
   ...
   public abstract fun cancel(pigeon_instance: HttpAuthHandler) {
   }

   public fun pigeon_newInstance(pigeon_instanceArg: HttpAuthHandler, callback: (Result<Unit>) -> Unit) {
      if (this.getPigeonRegistrar().getIgnoreCallsToDart()) {
         ...
         new BasicMessageChannel<>(
            ...
            .send(
               ...
               new PigeonApiHttpAuthHandler$$ExternalSyntheticLambda0(var2, "dev.flutter.pigeon.webview_flutter_android.HttpAuthHandler.pigeon_newInstance")
            );
      }
   }

   public abstract fun proceed(pigeon_instance: HttpAuthHandler, username: String, password: String) {
   }

   public abstract fun useHttpAuthUsernamePassword(pigeon_instance: HttpAuthHandler): Boolean {
   }
   ...
   public companion object {
      ...
      @JvmStatic
      fun `setUpMessageHandlers$lambda$1$lambda$0`(var0: PigeonApiHttpAuthHandler, var1: Any, var2: BasicMessageChannel.Reply) {
         var1 = (var1 as java.util.List).get(0);
         var1 = var1 as HttpAuthHandler;

         label12:
         try {
            var5 = CollectionsKt.listOf(var0.useHttpAuthUsernamePassword(var1));
      ...
      // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
      @JvmStatic
      fun `setUpMessageHandlers$lambda$3$lambda$2`(var0: PigeonApiHttpAuthHandler, var1: Any, var2: BasicMessageChannel.Reply) {
         var1 = (var1 as java.util.List).get(0);
         var1 = var1 as HttpAuthHandler;
      ...
      // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
      @JvmStatic
      fun `setUpMessageHandlers$lambda$5$lambda$4`(var0: PigeonApiHttpAuthHandler, var1: Any, var2: BasicMessageChannel.Reply) {
         ...
         label12:
         try {
            var0.proceed(var1, (java.lang.String)var3, (java.lang.String)var11);
      ...
      public fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiHttpAuthHandler?) {
         ...
         val var7: PigeonApiHttpAuthHandler.Companion = this;
         val var8: BasicMessageChannel = new BasicMessageChannel(
            var1, "dev.flutter.pigeon.webview_flutter_android.HttpAuthHandler.useHttpAuthUsernamePassword", var6
         );
         if (var2 != null) {
            var8.setMessageHandler(new PigeonApiHttpAuthHandler$Companion$$ExternalSyntheticLambda0(var2));
         } else {
            var8.setMessageHandler(null);
         }

         val var9: BasicMessageChannel = new BasicMessageChannel(var1, "dev.flutter.pigeon.webview_flutter_android.HttpAuthHandler.cancel", var6);
         if (var2 != null) {
            var9.setMessageHandler(new PigeonApiHttpAuthHandler$Companion$$ExternalSyntheticLambda1(var2));
         } else {
            var9.setMessageHandler(null);
         }

         val var5: BasicMessageChannel = new BasicMessageChannel(var1, "dev.flutter.pigeon.webview_flutter_android.HttpAuthHandler.proceed", var6);
         if (var2 != null) {
            var5.setMessageHandler(new PigeonApiHttpAuthHandler$Companion$$ExternalSyntheticLambda2(var2));
         } else {
