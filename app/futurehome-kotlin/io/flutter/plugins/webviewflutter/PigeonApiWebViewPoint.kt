...
public abstract class PigeonApiWebViewPoint {
   ...
   open fun PigeonApiWebViewPoint(var1: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
   ...
   public fun pigeon_newInstance(pigeon_instanceArg: WebViewPoint, callback: (Result<Unit>) -> Unit) {
         ...
         new BasicMessageChannel<>(
            ...
            .send(
               CollectionsKt.listOf(
                  new java.lang.Long[]{this.getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(var1), this.x(var1), this.y(var1)}
               ),
               new PigeonApiWebViewPoint$$ExternalSyntheticLambda0(var2, "dev.flutter.pigeon.webview_flutter_android.WebViewPoint.pigeon_newInstance")
            );
      }
   }

   public abstract fun x(pigeon_instance: WebViewPoint): Long {
   }

   public abstract fun y(pigeon_instance: WebViewPoint): Long {
   }
}
